...
/**
 * Busca dados de um CNPJ usando a API proxy interna e preenche o formulário.
 * @param form - A instância do react-hook-form a ser preenchida.
 * @param toast - A função de toast para exibir mensagens.
 * @returns Uma função que, quando chamada, executa a busca.
 */
export const createCnpjLookup = (
    ...
    return async () => {
        const cnpjValue = form.getValues("cpfCnpj") || form.getValues("inscricao");
        ...
        try {
            ...
            toast({
                title: "Dados do Parceiro Carregados!",
